...
class Prompts:
    ...
    def reply_prose_claim_grounding_prompt(
        ...
        return (
            ...
            "every SHA the prose names appears in it (catches PR #1858's "
            "empty-commit lies).  If ``recent_commit_shas`` is empty, the "
            "caller hasn't gathered commit ground truth — this axis "
            "passes by default rather than rejecting every commit mention.\n"
